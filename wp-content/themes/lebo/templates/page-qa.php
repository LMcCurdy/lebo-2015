          ...
          <div id="main" class="col-md-8 clearfix" role="main">
            ...
            <div class="flipcon">
              <div class="flipped" style="display:none;">
                   ...
                   <a href="#qa-1" class="btn2 scroll">BOTOX<sup>®</sup></a>
                   <a href="#qa-2" class="btn2 scroll">Chemical Peels</a>
                   <a href="#qa-3" class="btn2 scroll">CO2RE<sup>™</sup> Laser</a>
                   <a href="#qa-4" class="btn2 scroll">CoolSculpting<sup>®</sup></a>
                   <a href="#qa-5" class="btn2 scroll">Cosmetic Fillers</a>
                   </div>

                    <div class="column four">
                   <a href="#qa-6" class="btn2 scroll">Dermapen<sup>®</sup></a>
                   <a href="#qa-7" class="btn2 scroll">Isolaz<sup>™</sup></a>
                   <a href="#qa-8" class="btn2 scroll">Laser Hair Removal</a>
                  ...
                  <a href="#qa-11" class="btn2 scroll">Permanent Makeup</a>
                   ...
                   <a href="#qa-14" class="btn2 scroll">SmartLipo<sup>™</sup></a>
                   <a href="#qa-15" class="btn2 scroll">Tattoo Removal</a>
                   <a href="#qa-16" class="btn2 scroll">VelaShape<sup>™</sup></a>
                   </div>
              </div>
            </div>
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
              ...
              <div class="q-con">
                        ...
                        <?php  $args = array( 'post_type' => 'videos', 'video-type' => 'qa', 'posts_per_page' => '20', 'order' => 'ASC', 'orderby' => 'title');
